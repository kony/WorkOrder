    ...
    return {
        ...
        fetchAndSetData: function() {
            ...
            try {
                ...
                if (this.view.flxList.flxChart.isVisible)
                    this.view.segList.height = "61%";
                else
                    this.view.segList.height = "92%";
                    ...
                    if (widget.getComponentType() !== undefined && widget.getComponentType() == "sheetTextBox") {
                        ...
                        if (widget.getLabelData() !== undefined) {
                            if (widget.columnName === charIndex) {
                                ...
                                if (selectedValue !== "")
                                    widget.setLabelData(selectedValue);
                        ...
                        if (widget.getLabelData() !== undefined) {
                            if (widget.columnName === charIndex) {
                                ...
                                if (selectedDate !== "")
                                    widget.setLabelData(selectedDate);
                                textValue = widget.getLabelData();
                                widget.resetSelectedValue();
                            }
                        }
        ...
        _updateData: function(data) {
            ...
            try {
                ...
                var index = 0;
                if (this._lastRowFirst)
                    index = Number(this._rowNumberSelectedRev + this._evaluateRowBuffer(rangeForIndex)).toFixed().toString();
                else
                    index = Number(this._rowNumberSelected + this._evaluateRowBuffer(rangeForIndex)).toFixed().toString();
                var getFirstColumn = this._getFirstColumnName(this._range);
                var getLastColumn = this._getLastColumnName(this._range);
